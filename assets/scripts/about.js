...
document.addEventListener("DOMContentLoaded", () => {
    ...
    heroTll
        .from(".services-hero-content .tag", {
            ...
            onComplete: () => {
                document
                    .querySelector(".services-hero-content .tag")
    ...
    if (
        typeof am5viewer !== "undefined" &&
        document.getElementById("globalMapChart")
    ) {
        am5viewer.create("globalMapChart", {
            settings: {
                ...
                "editor.map": {
                    ...
                    themeTags: ["map"],
                    translateX: 763.9379794568821,
                    translateY: 372.82978441305477,
                    panY: "rotateY",
                    ...
                    homeGeoPoint: {
                        longitude: 29.533460163474434,
                        latitude: 28.439045040740034,
                    },
                ...
                "editor.pixelTemplate": {
                    ...
                    userData: {
                        point1: {
                            longitude: 107.88761706555671,
                            latitude: -39.369976033727845,
                        },
                        point2: {
                            longitude: 115.37981269510925,
                            latitude: -39.369976033727845,
                        },
                    },
                },
                ...
                "editor.pointSeries": [
                    {
                        ...
                        settings: {
                            ...
                            settings: {
                                ...
                                x: {
                                    type: "Percent",
                                    value: 57.96875158945719,
                                },
                                y: {
                                    type: "Percent",
                                    value: 49.300410685388805,
                                },
                            },
                        },
                        pointType: "Balloon",
                ...
                "editor.labelSeries": [
                    {
                        ...
                        geometry: {
                            type: "Point",
                            coordinates: [
                                44.68543485133088, 24.864475573197602,
                            ],
                            __parse: false,
                        },
                        id: "label_1",
        ...
        ScrollTrigger.create({
            ...
            once: true,
            onEnter: () => {
                const globalStats = document.querySelectorAll(
    ...
    window.addEventListener("languageChanged", () => {
        ...
        if (typeof initStructureAnimation === "function")
            initStructureAnimation();
        if (typeof initPhilosophyAnimation === "function")
    ...
    if (diagram) {
        ...
        function setActiveNode(name) {
            ...
            infoItems.forEach((item) => {
                item.classList.toggle("is-active", item.dataset.node === name);
            });
        }
    ...
    function initStructureAnimation() {
        ...
        const strokeElements = triangleSVG.querySelectorAll(
            ".st2, .st3, .st4, .st5",
        );
    ...
    const sectorCards = document.querySelectorAll(
        ".about-sectors .sector-card",
    );
    ...
    function initPhilosophyAnimation() {
        ...
        // Get all stroke elements (paths and lines) - support multiple class versions
        const strokeElements = philosophySVG.querySelectorAll(
            ".st2-2, .st3-2, .st4, .st5",
        );
        ...
        const autoScroll = () => {
            if (!isDown) {
                ...
                if (clientsSection.scrollLeft <= 0)
                    clientsSection.scrollLeft = half;
                if (clientsSection.scrollLeft >= half * 2)
                    clientsSection.scrollLeft = half;
            }
